...
namespace EG.Utility.DBCommon
{
    public sealed class OracleHelper
    {
        ...
        private static void PrepareCommand(IDbCommand command, IDbConnection connection, OracleTransaction transaction, CommandType commandType, string commandText, IDbDataParameter[] commandParameters, out bool mustCloseConnection)
        {
            if (command == null) throw new ArgumentNullException("command");
        ...
        public static DataSet ExecuteDataset(IDbConnection connection, CommandType commandType, string commandText, params IDbDataParameter[] commandParameters)
        {
            if (connection == null)
            {
                //if (Log.Log.isInfoEnable())
                //{
                //    Log.Log.Log_Info("OracleHelper", "connection string is null");
                //}
                throw new ArgumentNullException("connection");
            }

            //if (Log.Log.isDebugEnable())
            //{
            //    Log.Log.Log_DEBUG("OracleHelper", " Start ExecuteDataset: " + commandText);
            //}
        ...
        private static OracleDataReader ExecuteReader(OracleConnection connection, OracleTransaction transaction, CommandType commandType, string commandText, OracleParameter[] commandParameters, OracleConnectionOwnership connectionOwnership)
        {
            ...
            try {
                ...
                // then the OracleReader cant set its values. 
