...
namespace EG.Utility.DBCommon
{
    public sealed class MySQLHelper
    {
        ...
        public static int ExecuteNonQuery(MySqlConnection connection, CommandType commandType, string commandText, params MySqlParameter[] commandParameters)
        {
            if (connection == null)
            {
                Log.Log_Info("MySQLHelper", "connection string is null");
            ...
            Log.Log_DEBUG("MySQLHelper", " Start ExecuteSQL: " + commandText);
            ...
            Log.Log_DEBUG("MySQLHelper", " End ExecuteSQL");
            return retval;
        }
        ...
        public static DataSet ExecuteDataset(MySqlConnection connection, CommandType commandType, string commandText, params MySqlParameter[] commandParameters)
        {
            if (connection == null)
            {
                Log.Log_Info("OracleHelper", "connection string is null");
                throw new ArgumentNullException("connection");
            }
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(MySqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySQLHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySQLHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
            }
        }
